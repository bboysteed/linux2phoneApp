...
import com.example.linux2phonee.R;
...
public class TermuxDocumentsProvider extends DocumentsProvider {
    ...
    private static final File BASE_DIR = new File("/data/data/com.example.linux/");
    ...
    public Cursor querySearchDocuments(String rootId, String query, String[] projection) throws FileNotFoundException {
        ...
        while (!pending.isEmpty() && result.getCount() < MAX_SEARCH_RESULTS) {
            ...
            try {
                isInsideHome = file.getCanonicalPath().startsWith(BASE_DIR.toString());
            } catch (IOException e) {
                isInsideHome = true;
            }
            if (isInsideHome) {
